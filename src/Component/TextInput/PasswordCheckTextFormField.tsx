...
import PasswordWatchSvg from 'src/Resource/svg/password-watch-gray-icon.svg';
import PasswordWatchFilledSvg from 'src/Resource/svg/password-watch-blue-icon.svg';
