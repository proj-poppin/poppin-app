          ...
          {step === 2 && (
            <>
              ...
              <View style={[{paddingHorizontal: 10}, {paddingVertical: 10}]}>
                ...
                />
                <Text
                  style={[globalStyles.labelSubGray, {paddingVertical: 10}]}>
...
const styles = StyleSheet.create({
  ...
  option: {
    ...
    alignItems: 'center',
    borderBottomWidth: 1,
    borderBottomColor: primaryColors.warmGray,
  },
  selectedOption: {
    backgroundColor: primaryColors.blue, // 선택된 옵션의 배경색 변경
  },
  text: {
    color: primaryColors.font,
  },
  selectedText: {
    color: primaryColors.blue, // 선택된 옵션의 텍스트 색상 변경
  },
});
