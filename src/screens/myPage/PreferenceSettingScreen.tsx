...
function PreferenceSettingScreen({navigation}) {
  ...
  return (
    <DismissKeyboardView style={styles.container}>
      <View>
        <Text style={[globalStyles.title, {marginTop: 20, marginBottom: 10}]}>
          <Text style={{color: primaryColors.blue}}>{'콩나물 부침개'}</Text>
          <Text>{'님의 팝업 취향을'}</Text>
        </Text>
        <View style={styles.selectionRow}>
          ...
          <Text style={[globalStyles.labelSub, {marginLeft: 4, marginTop: 2}]}>
            {'(카테고리 당 1개 이상 필수 선택)'}
          </Text>
        </View>
      </View>
