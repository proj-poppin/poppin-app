        ...
        <View style={styles.emailContainer}>
          ...
          <View
            style={[
              ...
              isNicknameFocused && {borderColor: primaryColors.blue},
            ]}>
            <TextInput
...
const styles = StyleSheet.create({
  ...
  inputContainer: {
    ...
    borderColor: primaryColors.warmGray, // 테두리 색상을 primaryColors.component로 설정
  ...
  preferenceButton: {
    ...
    backgroundColor: primaryColors.blue, // 버튼 배경색
