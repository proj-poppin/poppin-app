    ...
    navigation.setOptions({
      headerRight: () => (
        <Pressable onPress={() => setModalVisible(true)}>
          <Text style={{color: primaryColors.font, marginRight: 0}}>
            건너뛰기
          </Text>
        </Pressable>
      ),
    ...
    <View style={{flex: 1}}>
      ...
      <ScrollView style={styles.container}>
        <View style={styles.contentContainer}>
          <Text style={[globalStyles.headline, {textAlign: 'center'}]}>
            {steps[step - 1].text1}
            {'\n'}
            {steps[step - 1].text2}
          </Text>
          <Text
            style={[
              ...
              {color: primaryColors.blue, textAlign: 'center', paddingTop: 50},
            ]}>
            *복수 선택 가능
          </Text>
          {renderOptionButtons()}
          <Text
            style={[
              globalStyles.labelSub,
              {color: primaryColors.font, paddingTop: 30},
            ]}>
